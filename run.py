...
def set_sim_input_config(simulator, cfg_path, design_target, cache_access_mode, associativity, process_node, _opt_target, word_width, device_roadmap, _capacity, banks, _bank_org, mat_org, _stacked_die_count, _monolithic_layer_count, _temperature, cell_cfg, hybrid, second_cell_cfg):
  ...
  if simulator == "destiny":
      sim_input_cfg = nvmexplorer_src.input_defs.destiny_interface.DestinyInputConfig(mem_cfg_file_path = cfg_path, process_node = process_node,
                                       ...
                                       cache_access_mode = cache_access_mode,
                                       ...
                                       cell_type = cell_cfg,
                                       hybrid = hybrid,
                                       second_cell_type = second_cell_cfg)
...
if __name__ == '__main__':
  ...
  if "hybrid" in config["experiment"]:
      if config["experiment"]["hybrid"]:
  ...
  if "design_target" in config["experiment"]:
      if config["experiment"]["design_target"]:
          design_target = config["experiment"]["design_target"]
  ...
  if "bank_org" in config["experiment"]:
      if config["experiment"]["bank_org"]:
          bank_org = config["experiment"]["bank_org"]
  if "mat_org" in config["experiment"]:
      if config["experiment"]["mat_org"]:
          mat_org = config["experiment"]["mat_org"]
  if "vdd_vth" in config["experiment"]:
      if config["experiment"]["vdd_vth"]:
          vdd_vth = config["experiment"]["vdd_vth"]
      ...
      for _process_node in process_node:
          for _opt_target in opt_target:
              for _capacity in capacity:
                  for _word_width in word_width:
                      for _banks in banks:
                          for _bank_org in bank_org:
                                              ...
                                              for _temperature in temperature:
                                                  ...
                                                  if hybrid:
                                                      if _first_cell_type != "eDRAM":
                                                          data_df = load_spreadsheet_data(_first_cell_type, output_path)
                                                      if _second_cell_type != "eDRAM":
                                                          second_data_df = load_spreadsheet_data(_second_cell_type, output_path)
                                                  else:
                                                      if _cell_type != "eDRAM":
                                                  ...
                                                  results_csv = "{}/results/{}_{}MB_{}b_{}banks_{}bankorg_{}matorg_{}_{}BPC_{}nm_{}stackeddies_{}monolithiclayers_{}K_{}_{}_{}-{}.csv".format(output_path, _cell_type, _capacity, _word_width, _banks, _bank_org, mat_org, _opt_target, _bits_per_cell, _process_node, _stacked_die_count, _monolithic_layer_count, _temperature, _vdd, _vth, simulator, exp_name)    
                                                  ...
                                                  if (cell_tentpoles == True): #set up default, tentpole-style study per cell type
                                                      ...
                                                      if hybrid:
                                                          best_case_cell_path, worst_case_cell_path, best_case_cell_cfg, worst_case_cell_cfg = form_tentpoles(data_df, _first_cell_type, _bits_per_cell)
                                                          second_best_case_cell_path, second_worst_case_cell_path, second_best_case_cell_cfg, second_worst_case_cell_cfg = form_tentpoles(second_data_df, _second_cell_type, _bits_per_cell)
                                                      else:
                                                      ...
                                                      best_case_cfg_path = "data/mem_cfgs/{}_{}MB_{}b_{}_{}BPC_{}nm_{}stackeddies_{}monolithiclayers_{}K_{}_{}-best_case.cfg".format(_cell_type, _capacity, _word_width, _opt_target, _bits_per_cell, _process_node, _stacked_die_count, _monolithic_layer_count, _temperature, _vdd, _vth)
                                                      worst_case_cfg_path = "data/mem_cfgs/{}_{}MB_{}b_{}_{}BPC_{}nm_{}stackeddies_{}monolithiclayers_{}K_{}_{}-worst_case.cfg".format(_cell_type, _capacity, _word_width, _opt_target, _bits_per_cell, _process_node, _stacked_die_count, _monolithic_layer_count, _temperature, _vdd, _vth)
                                                      best_case_stdout_log = "{}/logs/{}_{}MB_{}b_{}_{}BPC_{}nm_{}stackeddies_{}monolithiclayers_{}K_{}_{}-best_case_output".format(output_path, _cell_type, _capacity, _word_width, _opt_target, _bits_per_cell, _process_node, _stacked_die_count, _monolithic_layer_count, _temperature, _vdd, _vth)
                                                      best_case_stderr_log = "{}/logs/{}_{}MB_{}b_{}_{}BPC_{}nm_{}stackeddies_{}monolithiclayers_{}K_{}_{}-best_case_error".format(output_path, _cell_type, _capacity, _word_width, _opt_target, _bits_per_cell, _process_node, _stacked_die_count, _monolithic_layer_count, _temperature, _vdd, _vth)
                                                      worst_case_stdout_log = "{}/logs/{}_{}MB_{}b_{}_{}BPC_{}nm_{}stackeddies_{}monolithiclayers_{}K_{}_{}-worst_case_output".format(output_path, _cell_type, _capacity, _word_width, _opt_target, _bits_per_cell, _process_node, _stacked_die_count, _monolithic_layer_count, _temperature, _vdd, _vth)
                                                      worst_case_stderr_log = "{}/logs/{}_{}MB_{}b_{}_{}BPC_{}nm_{}stackeddies_{}monolithiclayers_{}K_{}_{}-worst_case_error".format(output_path, _cell_type, _capacity, _word_width, _opt_target, _bits_per_cell, _process_node, _stacked_die_count, _monolithic_layer_count, _temperature, _vdd, _vth)

                                                      ## Generate corresponding mem cfgs
                                                      sim_best_case_input_cfg = set_sim_input_config(simulator, best_case_cfg_path, design_target, cache_access_mode, associativity, _process_node, _opt_target, _word_width, device_roadmap, _capacity, _banks, _bank_org, mat_org, _stacked_die_count, _monolithic_layer_count, _temperature, best_case_cell_cfg, hybrid, second_best_case_cell_cfg)
                                                      sim_worst_case_input_cfg = set_sim_input_config(simulator, worst_case_cfg_path, design_target, cache_access_mode, associativity, _process_node, _opt_target, _word_width, device_roadmap, _capacity, _banks, _bank_org, mat_org, _stacked_die_count, _monolithic_layer_count, _temperature, worst_case_cell_cfg, hybrid, second_worst_case_cell_cfg)
                                                      sim_worst_case_input_cfg.generate_mem_cfg()
                                                      sim_best_case_input_cfg.generate_mem_cfg()

                                                      worst_output_path = "{}/sim_output/{}_{}MB_{}_{}BPC_{}nm_{}stackeddies_{}monolithiclayers_{}K_{}_{}_{}b-worst_case_sim_output.pkl".format(output_path, _cell_type, _capacity, _opt_target, _bits_per_cell, _process_node, _stacked_die_count, _monolithic_layer_count, _temperature, _vdd, _vth, _word_width)
                                                      best_output_path = "{}/sim_output/{}_{}MB_{}_{}BPC_{}nm_{}stackeddies_{}monolithiclayers_{}K_{}_{}_{}b-best_case_sim_output.pkl".format(output_path, _cell_type, _capacity, _opt_target, _bits_per_cell, _process_node, _stacked_die_count, _monolithic_layer_count, _temperature, _vdd, _vth, _word_width)
                                                      ...
                                                      if len(config["custom_cells"]) == 0: #use default values per technology
                                                        if _capacity < 1:
                                                            scaled_capacity = int(_capacity*1000*1024)
                                                        else:
                                                            scaled_capacity = _capacity*1024*1024
                                                        extra_args = "{} {} {} {} {} cache".format(_temperature, _process_node, _vdd, _vth, scaled_capacity) # for cryomem only; use cacti config corresponding to cell type
                                                        this_cell_path, this_cell_cfg = gen_custom_cell(_cell_type, _temperature, _vdd, _vth, {"name":"default", "bits_per_cell":_bits_per_cell}, simulator)
                                                        this_cfg_path = "data/mem_cfgs/{}_{}MB_{}b_{}banks_{}bankorg_{}matorg_{}_{}BPC_{}nm_{}stackeddies_{}monolithiclayers_{}K_{}_{}_{}.cfg".format(_cell_type, _capacity, _word_width, _banks, _bank_org, mat_org, _opt_target, _bits_per_cell, _process_node, _stacked_die_count, _monolithic_layer_count, _temperature, _vdd, _vth, "default")
                                                        sim_input_cfg = set_sim_input_config(simulator, this_cfg_path, design_target, cache_access_mode, associativity, _process_node, _opt_target, _word_width, device_roadmap, _capacity, _banks, _bank_org, mat_org, _stacked_die_count, _monolithic_layer_count, _temperature, this_cell_cfg)
                                                        ...
                                                        output_paths.append("{}/sim_output/{}_{}MB_{}banks_{}bankorg_{}matorg_{}_{}BPC_{}nm_{}stackeddies_{}monolithiclayers_{}K_{}_{}_{}b_{}_{}_output.pkl".format(output_path, _cell_type, _capacity, _banks, _bank_org, mat_org, _opt_target, _bits_per_cell, _process_node, _stacked_die_count, _monolithic_layer_count, _temperature, _vdd, _vth, _word_width, "default", simulator))
                                                        stdout_logs.append("{}/logs/{}_{}MB_{}banks_{}bankorg_{}matorg_{}_{}BPC_{}nm_{}stackeddies_{}monolithiclayers_{}K_{}_{}_{}b_{}_output".format(output_path, _cell_type, _capacity, _banks, _bank_org, mat_org, _opt_target, _bits_per_cell, _process_node, _stacked_die_count, _monolithic_layer_count, _temperature, _vdd, _vth, _word_width, "default"))
                                                        stderr_logs.append("{}/logs/{}_{}MB_{}banks_{}bankorg_{}matorg_{}_{}BPC_{}nm_{}stackeddies_{}monolithiclayers_{}K_{}_{}_{}b_{}_error".format(output_path, _cell_type, _capacity, _banks, _bank_org, mat_org, _opt_target, _bits_per_cell, _process_node, _stacked_die_count, _monolithic_layer_count, _temperature, _vdd, _vth, _word_width, "default"))
                                                      else:
                                                        for i in range(len(config["custom_cells"])):
                                                          ...
                                                          if this_custom_cell_input["cell_type"] == _cell_type:
                                                            ...
                                                            this_cell_path, this_cell_cfg = gen_custom_cell(_cell_type, _temperature, _vdd, _vth, this_custom_cell_input, simulator)
                                                            this_cfg_path = "data/mem_cfgs/{}_{}MB_{}b_{}banks_{}bankorg_{}matorg_{}_{}BPC_{}nm_{}stackeddies_{}monolithiclayers_{}K_{}_{}_{}.cfg".format(_cell_type, _capacity, _word_width, _banks, _bank_org, mat_org, _opt_target, _bits_per_cell, _process_node, _stacked_die_count, _monolithic_layer_count, _temperature, _vdd, _vth, this_custom_cell_input["name"])
                                                            sim_input_cfg = set_sim_input_config(simulator, this_cfg_path, design_target, cache_access_mode, associativity, _process_node, _opt_target, _word_width, device_roadmap, _capacity, _banks, _bank_org, mat_org, _stacked_die_count, _monolithic_layer_count, _temperature, this_cell_cfg)
                                                            ...
                                                            cfg_paths.append(this_cfg_path)
                                                            sim_input_cfgs.append(sim_input_cfg)
                                                            output_paths.append("{}/sim_output/{}_{}MB_{}banks_{}bankorg_{}matorg_{}_{}BPC_{}nm_{}stackeddies_{}monolithiclayers_{}b_{}_{}_output.pkl".format(output_path, _cell_type, _capacity, _banks, _bank_org, mat_org, _opt_target, _bits_per_cell, _process_node, _stacked_die_count, _monolithic_layer_count, _word_width, this_custom_cell_input["name"], simulator))
                                                            stdout_logs.append("{}/logs/{}_{}MB_{}b_{}banks_{}bankorg_{}matorg_{}_{}BPC_{}nm_{}stackeddies_{}monolithiclayers_{}_output".format(output_path, _cell_type, _capacity, _word_width, _banks, _bank_org, mat_org, _opt_target, _bits_per_cell, _process_node, _stacked_die_count, _monolithic_layer_count, this_custom_cell_input["name"]))
